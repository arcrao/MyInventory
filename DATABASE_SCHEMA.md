...
CREATE TABLE history (
  ...
  product_name TEXT,  -- Stores product name for audit trail (persists even when product is deleted)
  ...
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
  -- Note: When a product is deleted, product_id becomes NULL but product_name
  -- preserves the product name for complete audit trail and compliance
);
